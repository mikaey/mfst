mfst: mfst.o base64.o state.o device.o util.o crc32.o sql.o lockfile.o ncurses.o block_size_test.o rng.o messages.o
	gcc -g -o mfst mfst.o state.o base64.o util.o device.o crc32.o sql.o lockfile.o ncurses.o block_size_test.o rng.o messages.o -pthread -lncurses -ludev -ljson-c -lmariadb -luuid
